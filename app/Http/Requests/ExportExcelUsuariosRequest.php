...
class ExportExcelUsuariosRequest extends FormRequest
{
    use RequestOrdenacionTrait;

    /**
     * Autoriza la petición exigiendo permiso de exportación de usuarios.
     */
    public function authorize(): bool
    {
        // Comprobamos que el usuario autenticado puede exportar usuarios
        return $this->user()?->can(PermissionHelper::USUARIOS_EXPORTAR_PERMISSION) ?? false;
    }
