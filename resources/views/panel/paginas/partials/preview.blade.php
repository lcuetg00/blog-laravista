...
<section id="paginaPreview" class="preview-panel shadow @if ($minimizado) is-minimized @endif"
    ...
    <header class="preview-panel-header" data-preview-drag>
        ...
        <span class="preview-panel-actions">
            ...
            <span class="preview-panel-sizes" role="group" aria-label="{{ trans('fields.paginas.preview.size') }}">
                <button type="button" class="preview-panel-btn popup" data-preview-size="movil"
                    aria-label="{{ trans('fields.paginas.preview.movil') }}"
                    data-popup="{{ trans('fields.paginas.preview.movil') }}">
                    <i class="fa-solid fa-mobile-screen-button" aria-hidden="true"></i>
                </button>
                <button type="button" class="preview-panel-btn popup" data-preview-size="tablet"
                ...
                <button type="button" class="preview-panel-btn popup" data-preview-size="escritorio"
                    aria-label="{{ trans('fields.paginas.preview.escritorio') }}"
                    data-popup="{{ trans('fields.paginas.preview.escritorio') }}">
                    <i class="fa-solid fa-desktop" aria-hidden="true"></i>
                </button>
                <button type="button" class="preview-panel-btn popup" data-preview-flip
            ...
            <span class="preview-panel-divider" aria-hidden="true"></span>

            <a href="{{ route($pagina->clave) }}" target="_blank" rel="noopener" class="preview-panel-btn popup"
